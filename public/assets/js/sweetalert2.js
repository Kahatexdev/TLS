...
(function (global, factory) {
  ...
  var warnAboutDeprecation = function warnAboutDeprecation(deprecatedParam) {
    ...
    warnOnce(
      '"'
        ...
        .concat(useInstead ? ' Use "'.concat(useInstead, '" instead.') : "")
    );
  };
  ...
  var applyCustomClass = function applyCustomClass(elem, params, className) {
    ...
    var customClass =
      params.customClass[/** @type {keyof SweetAlertCustomClass} */ className];
    if (!customClass) {
      return;
    }
  ...
  var getInputContainer = function getInputContainer(inputType) {
    ...
    return getDirectChildByClass(
      popup,
      swalClasses[/** @type {SwalClass} */ inputType] || swalClasses.input
    );
  };
      ...
      return _createClass(MixinSwal, [
        {
          ...
          value: function _main(params, priorityMixinParams) {
            return _superPropGet(
              ...
              "_main",
              this
            )([params, Object.assign({}, mixinParams, priorityMixinParams)]);
          },
        },
      ]);
    })(this); // @ts-ignore
  ...
  var getSwalParams = function getSwalParams(templateContent) {
    ...
    swalParams.forEach(function (param) {
      ...
      var paramName =
        /** @type {keyof SweetAlertOptions} */ param.getAttribute("name");
