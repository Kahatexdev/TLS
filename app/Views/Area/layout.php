    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " data-color="primary" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="<?= base_url('/capacity') ?> " target="_blank">
                ...
                <span class="ms-1 font-weight-bold" style="font-size: 20px;">TLS</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse h-auto  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link  <?= $active1 ?>" href="<?= base_url('monitoring') ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $active2 ?> " href="<?= base_url('monitoring/dataproduksi') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $active3 ?> " href=" <?= base_url('monitoring/dataorder') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            <a href="https://woz-u.com/wp-content/uploads/2020/04/how-stressful-is-software-development-woz-u-1280x720.jpg" class="font-weight-bold" target="_blank">Yora Barera</a>
                            BP System
                        </div>
                    </div>
