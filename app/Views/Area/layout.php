    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " data-color="primary" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse h-auto  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link  <?= $active1 ?>" href="<?= base_url('area') ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $active2 ?> " href="<?= base_url('area/dataproduksi') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $active3 ?> " href=" <?= base_url('area/dataorder') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
